        ...
        <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">Inserir Despesa</h3>
                                        </div>
                                        <hr>
                                        <form action="addgastos.php" method="post" novalidate="novalidate">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Respnsável</label>
                                                <input id="cc-pament" disabled  name="responsavel" type="text" class="form-control"  value="  <?php echo $nome1; ?>">
                                            </div>
                                            <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1">valor</label>
                                                <input id="cc-name" name="valor" type="number" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
                                                    aria-required="true" aria-invalid="false" aria-describedby="cc-name-error">
                                                <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="cc-number" class="control-label mb-1">DESCRIÇÃO</label>
                                                <input  name="descricao" type="CPF" class="form-control cc-number identified visa" value="" data-val="true"
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="cc-exp" disabled  name="data" type="tel" class="form-control cc-exp" value=" <?php 
                                                        $hoje=date('d/m/Y', time());;
                                                        echo $hoje;?>" data-val="true" data-val-required="Please enter the card expiration"
                                                            data-val-cc-exp="Please enter a valid month and year" placeholder="D / M / A"
                                                            autocomplete="cc-exp">
                                            ...
                                            <div>
                                                <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                                    ...
                                                    <span id="payment-button-amount">Cadastrar Despesa</span>
              ...
              <div class="card">
                <div class="card-body">
                  <p  id="#pesquisar" class="card-title">
                  <script>
                  function aparecemes(){
                      
                      document.getElementById('mes').style.display="inline";
                       document.getElementById('hoje').style.display="none";
                       document.getElementById('ano').style.display="none"; 
                       document.getElementById('bmes').style.background="#b8fbba"; 
                       document.getElementById('bhoje').style.background="#17a2b8"; 
                        document.getElementById('bano').style.background="#17a2b8"; 
                        
                  }
                   function aparecehoje(){
                      
                      document.getElementById('mes').style.display="none";
                       document.getElementById('hoje').style.display="inline";
                       document.getElementById('ano').style.display="none"; 
                       document.getElementById('bmes').style.background="#17a2b8"; 
                       document.getElementById('bhoje').style.background="#b8fbba"; 
                        document.getElementById('bano').style.background="#17a2b8";  
                  }
                   function apareceano(){
                      ...
                      document.getElementById('mes').style.display="none";
                       ...
                       document.getElementById('ano').style.display="inline";  
                         document.getElementById('bmes').style.background="#17a2b8"; 
                       document.getElementById('bhoje').style.background="#17a2b8"; 
                        document.getElementById('bano').style.background="#b8fbba"; 
                  }
                  </script>
                  <button id="bhoje" onclick="aparecehoje()" style="border:none;padding:4px;background:#b8fbba;color:white;border-radius:5px;margin-left:5px;">HOJE</button>
                  <button id="bmes" onclick="aparecemes()" style="border:none;padding:4px;background:#17a2b8;color:white;border-radius:5px;margin-left:5px;">ESTE MES</button>
                  <button id="bano" onclick="apareceano()" style="border:none;padding:4px;background:#17a2b8;color:white;border-radius:5px;margin-left:5px;">ESTE ANO</button>
                  </p>
                 <div id="hoje" class="table-responsive">
                    <table class="table">
                      <thead>
                    ...
                    date_default_timezone_set('America/Sao_Paulo');         
$hoje=date('d/m/Y', time());;
   $consulta = "SELECT * FROM `gastos` WHERE `data` LIKE '$hoje'";
 $resultado = $conn->query($consulta) or die($conn->error);
 //enquando se dado for igual resultado jogar lista, faça-se a seguência do código abaixo
...
$somavaloresdia=$somavaloresdia+$valor;
$data2 = $pagame;
...
";
                         ...
                         ?>
                            <center><h5>VALOR TOTAL: <?php echo $somavaloresdia ?></h5></center>
                   ...
                   <div style="display:none;" id="ano" class="table-responsive">
                    <table class="table">
                      <thead>
                        <tr> <form  method="POST" action="" > 
                          <th>RESPONSÁVEL</th>
...
$somavaloresano=$somavaloresano+$valor;
...
<center><h5>VALOR TOTAL: <?php echo $somavaloresano ?></h5></center>
                   ...
                   <div style="display:none;" id="mes" class="table-responsive">
                    <table class="table">
                      <thead>
                        <tr> <form  method="POST" action="" > 
                          <th>RESPONSÁVEL</th>
...
$mes=date('m', time());;
   ...
   $consulta = "SELECT * FROM `gastos` WHERE `mes` LIKE '$mes'";
 $resultado = $conn->query($consulta) or die($conn->error);
 //enquando se dado for igual resultado jogar lista, faça-se a seguência do código abaixo
date_default_timezone_set('America/Sao_Paulo');
...
$date=  $dado["data"];
$horaa=  $dado["hora"];
$somavaloresmes=$somavaloresmes+$valor;
...
";
                   ...
                   <center><h5>VALOR TOTAL: <?php echo $somavaloresmes ?></h5></center>
