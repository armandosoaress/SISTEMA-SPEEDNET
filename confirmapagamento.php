                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">CONFIRMAÇÃO DE PAGAMENTO</h3>
                                        </div>
                                        <hr>
                                        
                                        <form action="processarpagamento.php" method="post" novalidate="novalidate">
                                            <div class="form-group">

                                            <input style="display:none" name="meuidparapagamento" value="<?php echo $pag; ?>"> 
...
?>" name="endereco" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
                                            ...
                                            <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1">FORMA DE PAGAMENTO</label>
                                                <input disabled id="cc-name" value="<?php
echo $endereco;
?>" name="endereco" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
                                                    aria-required="true" aria-invalid="false" aria-describedby="cc-name-error">
...
?>" data-val="true"
                                             ...
                                             <div class="form-group">
                                                <label for="cc-number" class="control-label mb-1">VALOR</label>
                                                <input   name="valor" type="tel" class="form-control cc-number identified visa" value="35" data-val="true"
                                                    data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                                    >
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">DATA DE PAGAMENTO</label>
...
?>" " data-val="true" data-val-required="Please enter the card expiration"
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">VENCIMENTO</label>
...
?>" data-val="true" data-val-required="Please enter the security code"
                                            ...
                                            <div>
                                                <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                                    ...
                                                    <span id="payment-button-amount">CONFIRMAR PAGAMENTO</span>
