...
?>
  ...
  <script>
                                    function direcionar2(){
                                        ...
                                        window.location.href = "ordemdeservico.php";
    ...
    <span style="padding:10px;border-radius:8px;" onclick="direcionar2()" class="au-btn au-btn-icon au-btn--blue">
...
?>
  ...
  <div style="margin-top:10px" class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <p  id="#pesquisar" class="card-title">ORDEM DE SERVIÇO</p>
                 <div class="table-responsive">
                    <table class="table">
                      <thead>
                        <tr> <form  method="POST" action="concluirordemdeservico.php" > 
                          <th>DESCRIÇÃO</th>
                          <th>ENDEDEÇO</th>
                           <th>RESPONSÁVEL</th>
                           <th>ENTRAGA</th>
...
if ($insta!=0) {
 ...
 $dtf= $dataFinal-31;
  ...
  echo "<td><label class='badge badge-danger'>$situacao</label></td>";
}
