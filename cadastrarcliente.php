                                ...
                                <div class="card">
                                   ...
                                   <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">CADASTRAR CLIENTES</h3>
                                        </div>
                                        <hr>
                                        <form action="enviarcadastrodeclienteparaobanco.php" method="post" novalidate="novalidate">
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                                   ...
                                                   <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1">DATA DE PAGAMENTO</label>
                                                <input id="cc-name" name="dataqueoclienteescolheuparapagamento" type="text" placeholder="digite o dia preferencial de pagamento" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
                                                    aria-required="true" aria-invalid="false" aria-describedby="cc-name-error">
                                                <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="cc-number" class="control-label mb-1">CPF</label>
                                                <input  name="cpf" type="CPF" class="form-control cc-number identified visa" value="" data-val="true"
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input  name="preco" type="tel" class="form-control cc-number identified visa" value="50" data-val="true"
                                                    data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                                    >
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">DATA DE NACIMENTO</label>
                                                        <input id="cc-exp" name="data" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
                                                            data-val-cc-exp="Please enter a valid month and year" placeholder="ex: 21/02/2001"
                                                            autocomplete="cc-exp">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="" name="telefone" type="tel" class="form-control cc-cvc" value="" data-val="true" data-val-required="Please enter the security code"
                                            ...
                                            <div>
                                                <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                                    ...
                                                    <span id="payment-button-amount">Cadastrar Cliente</span>
