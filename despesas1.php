                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="cc-exp" disabled  name="data" type="tel" class="form-control cc-exp" value=" <?php echo $data; ?>" data-val="true" data-val-required="Please enter the card expiration"
