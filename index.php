...
<head>
    ...
    <!-- Title Page-->
    <title>SISTEMA DE GESTÃO ACAD</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    ...
                                    <button onclick="cadastrarcliente()" class="au-btn au-btn-icon au-btn--blue">
                                    <script>
                                    function cadastrarcliente(){
                                        location.href="cadastrarcliente.php"
                                    }
                                    </script>
                                        <i class="zmdi zmdi-plus"></i>Cadastrar Cliente</button>
                                </div>
                            </div>
                        </div>
                        <div class="row m-t-25">
                          <script>
                                 function paginadecliente(){
                                        location.href="listadeclientes.php"
                                    }
                            </script>
                            <div onclick="paginadecliente()"; style='cursor:pointer;' class="col-sm-6 col-lg-3">
                            ...
                            <script>
                                ...
                                <div onclick="paginadespesas()"; style='cursor:pointer;' class="overview-item overview-item--c3">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            <div class="icon">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="au-card chart-percent-card">
                                    ...
                                    <li style="list-style:none; class="has-sub"> <h3 class="title-2 tm-b-5">RESUMO GERAL 2022 (%)</h3>
