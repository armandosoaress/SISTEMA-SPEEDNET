...
$cpf=  $dado["cpf"];
$datadeinscricao=  $dado["datadecadastro"];
$aniversario=  $dado["niver"];
$preco=  $dado["preco"]/35;
$datadepagamento=$dado["pagamento"];
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">SOBRE O CLIENTE</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">DETALHES</h3>
                                        </div>
                                        <hr>
                                        
                                        <form action="extratodecliente.php" method="post" novalidate="novalidate">
                                            <div class="form-group">

                                            <input style="display:none" name="meuidparaextrato" value="<?php echo $pag; ?>"> 
                                                <label for="cc-payment" class="control-label mb-1">NOME</label>
                                                <input disabled id="cc-pament" name="nome" type="text" class="form-control" aria-required="true" aria-invalid="false" value=" <?php
echo $nome;
?>
">
                                            </div>
                                            <div class="form-group has-success">
                                                ...
                                                <input disabled id="cc-name" value="<?php
echo $endereco;
?>" name="endereco" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
                                                    aria-required="true" aria-invalid="false" aria-describedby="cc-name-error">
                                                <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="cc-number" class="control-label mb-1">CPF</label>
                                                <input disabled name="cpf" type="CPF" class="form-control cc-number identified visa" value="<?php
echo $cpf;
?>" data-val="true"
                                            ...
                                            <div class="form-group">
                                                <label for="cc-number" class="control-label mb-1">DATA DE MATRICULA</label>
                                                <input disabled name="datadematricula" type="text" class="form-control cc-number identified visa" value="<?php
echo $datadeinscricao;
?>" data-val="true"
                                                    data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                                    >
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            ...
                                            <div class="form-group">
                                                <label for="cc-number" class="control-label mb-1">ANIVERSÁRIO</label>
                                                <input disabled name="aniversario" type="text" class="form-control cc-number identified visa" value="<?php
echo $aniversario;
?>" data-val="true"
                                                    data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                                    >
                                            ...
                                            <div class="form-group">
                                                <label for="cc-number" class="control-label mb-1">PARCELAS PAGAS</label>
                                                <input disabled name="PAGAS" type="text" class="form-control cc-number identified visa" value="<?php
echo $preco;
?>" data-val="true"
                                                    data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                                    >
                                             ...
                                             <div class="form-group">
                                                <label for="cc-number" class="control-label mb-1">MENSALIDADE</label>
                                                <input disabled  name="valor" type="tel" class="form-control cc-number identified visa" value="35" data-val="true"
                                                    data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                                    >
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">ULTIMA PAGAMENTO</label>
                                                        <input disabled id="cc-exp" name="data" type="tel" class="form-control cc-exp" value="<?php
echo $datahoje;
?>" " data-val="true" data-val-required="Please enter the card expiration"
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">PRÓXIMO PAGAMENTO</label>
                                                    <div class="input-group">
                                                        <input disabled id="" name="telefone" type="tel" class="form-control cc-cvc" value="<?php

                                                        if($vencimento==""){
                                                           echo "(Taxa Instalação)";
                                                        }else{
                                                            echo $vencimento;
                                                        }
...
?>" data-val="true" data-val-required="Please enter the security code"
                                            ...
                                            <div>
                                                ...
                                                <button   id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                                    ...
                                                    <span id="payment-button-amount">EXTRATOS DE PAGAMENTO</span>
