...
?>
  ...
  <div class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <p  id="#pesquisar" class="card-title">INSTALAÇÕES PENDENTES</p>
                 <div class="table-responsive">
                    <table class="table">
                      <thead>
                        <tr> <form  method="POST" action="instalacaorealizada.php" > 
                          <th>NOME</th>
                          <th>ENDEDEÇO</th>
   ...
   $consulta = "SELECT * FROM `produtos` WHERE `nome` LIKE '%$seach%' AND `instalada` = 0";
 $resultado = $conn->query($consulta) or die($conn->error);
 //enquando se dado for igual resultado jogar lista, faça-se a seguência do código abaixo
...
if ($insta!=0) {
 ...
 $dtf= $dataFinal-31;
  ...
  echo "<td><label class='badge badge-danger'>INTALAÇÃO PENDENTE</label></td>";
}
