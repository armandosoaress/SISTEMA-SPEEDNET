...
if(!empty($_SESSION['id'])){
 ...
 echo "<br>";
  ...
  header("Location: http://chataovivo.epizy.com/sistema2.0/sistema/soaresinfornet/login/login.php");  
...
?>
                               ...
                               <div class="col-md-16 stretch-card">
    <form class="au-form-icon--sm" action="" method="post">
                                    <input class="au-input--w300 au-input--style2" name="seach" type="text" placeholder="PESQUISAR PELO NOME">
...
?>
  ...
  <div class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <p  id="#pesquisar" class="card-title">PAGAMENTO</p>
                 <div class="table-responsive">
                    <table class="table">
                      <thead>
                        <tr> <form  method="POST" action="confirmapagamento.php" > 
                          <th>NOME</th>
                          <th>ENDEDEÇO</th>
 ...
 <th>PAGAS</th>
                      ...
                      <tbody>
                              ...
                              $seach = filter_input(INPUT_POST, 'seach', FILTER_SANITIZE_STRING);
$seach;
   $consulta = "SELECT * FROM `produtos` WHERE `nome` LIKE '%$seach%'";
 $resultado = $conn->query($consulta) or die($conn->error);
 //enquando se dado for igual resultado jogar lista, faça-se a seguência do código abaixo
date_default_timezone_set('America/Sao_Paulo');
...
if ($dataFinal<=31) {
 ...
 $dtf= $dataFinal-31;
  ...
  echo "<td><label class='badge badge-danger'>ATRASADO $dtf DIA(s) </label></td>";
}
