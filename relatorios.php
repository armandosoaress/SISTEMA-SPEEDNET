                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    ...
                                    <button style="background: #36eb7e;"  onclick="relatorioanual()" class="au-btn au-btn-icon au-btn--blue">
                                        RELATORIO 2021</button>

                                           <script>
                                    function relatoriomensal(){
                                        location.href="relatoriomensal.php"
                                    }
                                    </script>
                                    <button  onclick="relatoriomensal()" class="au-btn au-btn-icon au-btn--blue">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="au-card chart-percent-card">
                                    ...
                                    <li style="list-style:none; class="has-sub"> <h3 class="title-2 tm-b-5">RESUMO GERAL 2021 (%)</h3>
